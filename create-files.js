...
// ------------------------------------------------------------
//  फ़ाइल सामग्री (सभी पूर्ण कोड)
// ------------------------------------------------------------
const files = {
  // ---- constants ----
  'src/constants/constants.js': `export const ROLES = {
...
export function useAuth() {
  ...
  'src/hooks/useReports.js': `import { useState, useEffect, useCallback } from 'react';
...
export function useReports() {
  ...
  // ---- components: Auth ----
  'src/components/Auth/AuthContext.jsx': `import React, { createContext, useState, useEffect, useCallback } from 'react';
import { supabase } from '../../supabaseClient';
...
export const AuthProvider = ({ children }) => {
  ...
  'src/components/Auth/LoginScreen.jsx': `import React, { useState } from 'react';
...
export const LoginScreen = () => {
  ...
  // ---- components: Common ----
  'src/components/Common/Toast.jsx': `import React, { createContext, useState, useContext } from 'react';
...
export const useToast = () => useContext(ToastContext);`,
  ...
  'src/components/Common/UIComponents.jsx': `import React from 'react';
...
export const TblInput = ({ headers, rows, data, onChange }) => (
  ...
  'src/components/Common/CertificateModal.jsx': `import React, { useState } from 'react';
...
export const CertificateModal = ({ report, onConfirm, onCancel }) => {
  ...
  // ---- components: Report ----
  'src/components/Report/ReportForm.jsx': `import React, { useState } from 'react';
...
export const ReportForm = ({ initialData, onSave, onCancel }) => {
  ...
  'src/components/Report/ReportDataView.jsx': `import React from 'react';
...
export const ReportDataView = ({ report }) => {
  ...
  'src/components/Report/ReportPrintView.jsx': `import React, { useEffect } from 'react';
import { STATUS } from '../../constants/constants';
...
export const ReportPrintView = ({ report, onClose }) => {
  ...
  'src/components/Report/ConsolidatedReport.jsx': `import React, { useState, useEffect } from 'react';
...
export const ConsolidatedReport = ({ reports, selectedSections, sections, onBack }) => {
  ...
  'src/components/Dashboard/ActionDashboard.jsx': `import React, { useState } from 'react';
import { STATUS } from '../../constants/constants';
import { useAuth } from '../../hooks/useAuth';
import { useToast } from '../Common/Toast';
...
export const ActionDashboard = ({ reports, onEdit, setView, onPrint }) => {
  ...
  'src/components/Dashboard/HindiCellDashboard.jsx': `import React, { useState } from 'react';
import { STATUS } from '../../constants/constants';
import { getCurrentQuarterYear } from '../../utils/helpers';
...
export const HindiCellDashboard = ({ reports, sections, onSelectSections, selectedSections, onConsolidate }) => {
  ...
  'src/components/Dashboard/HindiCellReportsList.jsx': `import React, { useState } from 'react';
...
export const App = () => {
  ...
  'src/components/MainApp.jsx': `import React, { useState, useEffect } from 'react';
import { useAuth } from '../hooks/useAuth';
...
.print-container table { width: 100%; border-collapse: collapse; font-size: 13px; }
.print-container table th, .print-container table td { border: 1px solid #ccc; padding: 6px 8px; text-align: left; }
.audit-timeline {
...
.audit-timeline .entry .time { font-size: 12px; color: #64748b; }
.audit-timeline .entry .action { font-weight: 600; color: #1e293b; }
.report-data-table { width: 100%; border-collapse: collapse; font-size: 13px; }
.report-data-table td, .report-data-table th { border: 1px solid #e2e8f0; padding: 6px 10px; text-align: left; }
.report-data-table th { background: #f1f5f9; font-weight: 700; }
.spinner {
...
export default defineConfig({
  ...
  // We can't overwrite existing package.json, so we'll skip writing it.
  // The user can run npm install manually.
};

// ------------------------------------------------------------
//  स्क्रिप्ट क्रियान्वयन
// ------------------------------------------------------------
const rootDir = process.cwd();

// 1. निर्देशिकाएँ बनाएँ
dirs.forEach(dir => {
